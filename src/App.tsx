...
import ClipboardCopy from './components/clipboard-button'
    ...
    <div className="flex justify-center items-center h-screen">
      <ThemeProvider>
        <div className="flex flex-col justify-center items-center h-full w-full space-y-4">
          ...
          <div
            id="message-box"
            className="w-full max-w-3xl px-3 py-1 bg-zinc-100 shadow rounded-lg overflow-hidden flex flex-col max-h-[80vh] overflow-y-auto custom-scrollbar"
          >
            {messages.map((message, index) => (
              <div
                ...
                className={`flex items-center ${
                  message.isBot
                    ? 'space-x-1 p-2 justify-start mr-1'
                    : 'space-x-reverse space-x-1 p-2 justify-end mr-1'
                }`}
              >
                {message.isBot ? (
                  <>
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex-grow p-3 bg-white rounded-lg shadow text-black relative break-words">
                        <ReactMarkdown
                          components={{
                            code({ inline, className, children, ...props }) {
                              ...
                              return !inline && match ? (
                                <div className="relative">
                                  ...
                                  <ClipboardCopy>{children}</ClipboardCopy>
                                </div>
                              ) : (
                  ...
                  <>
                    ...
                    <div className="p-2 bg-white rounded-lg shadow text-black flex justify-between items-center">
                      {message.text}
                    </div>
                    <Avatar>
